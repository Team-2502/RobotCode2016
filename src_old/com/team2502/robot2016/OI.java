...
public class OI {
	...
	public OI() {
		...
		climbUpButton.whenPressed(new CommandClimber(CommandClimber.MotorMode.BOTH, 1));
		climbDownButton.whenPressed(new CommandClimber(CommandClimber.MotorMode.BOTH, -1));
